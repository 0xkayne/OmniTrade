...
| **6. Funding rate arbitrage** | Funding rate scanner, cross-venue pair matching, spread detection, hedged position lifecycle, CLI `onefill arb` | ~1776 | No | ✅ Complete (Aug 2026) |
