...
exchanges:
  lighter:
    type: native          # 使用原生 SDK
    enabled: true
    default_network: testnet
    networks:
      testnet:
        rest_base_url: https://testnet.zklighter.elliot.ai
        websocket_url: wss://testnet.zklighter.elliot.ai/ws
      mainnet:
        rest_base_url: https://api.lighter.xyz
        websocket_url: wss://ws.lighter.xyz
    symbols: ["ETH/USDC"]
    fees:
      taker: 0.0000
      maker: 0.0000
...
lighter:
  testnet:                     # 测试网配置
    ...
    api_private_key: "..."     # API 私钥 (40 字节 hex)
    api_key_index: 2           # API Key 索引
    account_index: 123         # 账户索引
  mainnet:                     # 主网配置
    wallet_address: "0x..."
    api_private_key: "..."
    api_key_index: 0
...
volume_farming:
  enabled: true
  exchanges: ["lighter", "hyperliquid"]  # 使用 Lighter 和 Hyperliquid
...
- ✅ 主网/测试网切换工具
- ✅ 多模式运行支持
- ✅ **Lighter 交易所原生 SDK 集成**

### 进行中 🚧
- 🚧 更多交易所适配器（Binance、OKX、dYdX 等）
- 🚧 完善单元测试与集成测试
- 🚧 Lighter 主网验证与优化
